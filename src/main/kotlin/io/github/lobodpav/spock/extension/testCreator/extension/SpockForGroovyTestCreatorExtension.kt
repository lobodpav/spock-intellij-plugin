 ...
 */
class SpockForGroovyTestCreatorExtension : SpockTestCreatorExtension<SpockForGroovyCreateTestAction>() {
    ...
    override val action: SpockForGroovyCreateTestAction
        get() = SpockForGroovyCreateTestAction()
}
